...
// 다른 JS에서도 제이쿼리에 접근할수 있다

// .css() 를 이용해서 style값을 바꿀수 있다
$("#header").css("color","blue");
// 값을 여러개 넣고 싶을때는 객체형태로 작성
...
$("#btn").on("click", function() {
    ...
    // this 통해서 현재 이벤트가 실행된 태그를 가져올수 있다
...
// 제이쿼리를 이용하여 버튼에 이벤트 넣기
// 여러개의 태그들을 배열로 처리하지않고 메소드를 이용해 모두 적용할 수 있다
